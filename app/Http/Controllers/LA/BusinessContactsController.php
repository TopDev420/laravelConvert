...
class BusinessContactsController extends Controller
{
    ...
    public $view_col = 'direct_phone';
    public $listing_cols = ['id', 'direct_phone', 'elink', 'clink', 'address1', 'address2', 'county', 'active', 'Business Model', 'first_name', 'last_name', 'job_title', 'email_address', 'company_name', 'company_website', 'phone_number', 'city', 'state', 'zipcode', 'country', 'industries', 'employees', 'revenue'];
    ...
    /**
     * Display a listing of the BusinessContacts.
     *
    ...
    /**
     * Store a newly created businesscontact in database.
     *
    ...
    public function show($id)
    {
        if (Module::hasAccess("BusinessContacts", "view")) {
            ...
            $businesscontact = BusinessContact::find($id);
            if (isset($businesscontact->id)) {
                $module = Module::get('BusinessContacts');
                $module->row = $businesscontact;
                ...
                ])->with('businesscontact', $businesscontact);
            } else {
                return view('errors.404', [
                    'record_id' => $id,
                    'record_name' => ucfirst("businesscontact"),
                ]);
            }
        } else {
            return redirect(config('laraadmin.adminRoute') . "/");
