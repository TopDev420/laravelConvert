...
class IndustryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (Module::hasAccess("Industries", "create")) {
            ...
            DB::table('industries')->where('id', $insert_id)->update(['slug' => $slug, 'banner_desc' => $bannerdescription, 'more_desc' => $moredescription, 'list_text' => $listtext, 'price' => 0, 'display_list_page' => $option]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if (Module::hasAccess("Industries", "edit")) {
            ...
            $slug = strtolower(str_replace(' ', '-', $name));
            DB::table('industries')->where('id', $insert_id)->update(['slug' => $slug, 'banner_desc' => $bannerdescription, 'more_desc' => $moredescription, 'list_text' => $listtext, 'display_list_page' => $option]);
    ...
    {
        $values = DB::table('industries')->select('id', 'name', 'display_list_page', 'price')->whereNull('deleted_at');
