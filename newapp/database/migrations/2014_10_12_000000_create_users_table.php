...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Users", 'users', 'name', 'fa-group', [
            ...
            ["type", "User Type", "Dropdown", false, "User", 0, 0, false, ["Admin","User"]],
            ["fname", "First Name", "Name", false, "", 0, 256, false],
            ["lname", "Last Name", "Name", false, "", 0, 256, false],
            ["cname", "Company Name", "Name", false, "", 0, 256, false],
