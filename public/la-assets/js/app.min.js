...
/* ================= File Manager ================= */
var bsurl = $('#upload_dir').val();//$('body').attr("bsurl");
...
$(document).ready(function() {
    ...
    function getLI(upload) {
        ...
        if($.inArray(upload.extension, ["jpg", "jpeg", "png", "gif", "bmp"]) > -1) {
            image = '<img src="'+bsurl+upload.name+'?s=130">';
        } else {
    ...
    $("body").on("click", ".fm_file_sel", function() {
        ...
        if(type == "image") {
            ...
            $hinput.next("a").next(".uploaded_image").children("img").attr("src", bsurl+upload.name+"?s=150");
        } else if(type == "file") {
            $hinput = $("input[name="+$("#image_selecter_origin").val()+"]");
            $hinput.val(upload.id);
            ...
            $hinput.next("a").next(".uploaded_file").attr("href", bsurl+upload.name);
        } else if(type == "files") {
            $hinput = $("input[name="+$("#image_selecter_origin").val()+"]");
            ...
            if(upload.extension == "jpg" || upload.extension == "png" || upload.extension == "gif" || upload.extension == "jpeg") {
                fileImage = "<img src='"+bsurl+upload.name+"?s=90'>";
            } else {
                fileImage = "<i class='fa fa-file-o'></i>";
            }
            $hinput.next("div.uploaded_files").append("<a class='uploaded_file2' upload_id='"+upload.id+"' target='_blank' href='"+bsurl+upload.name+"'>"+fileImage+"<i title='Remove File' class='fa fa-times'></i></a>");
        }
        $("#fm").modal('hide');
    });
});