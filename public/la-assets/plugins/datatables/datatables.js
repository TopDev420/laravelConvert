 ...
 *   https://datatables.net/download/#bs/dt-1.10.12,af-2.1.2,cr-1.3.2,fc-3.2.2,fh-3.1.2,kt-2.1.2,r-2.1.0,rr-1.1.2,sc-1.4.2,se-1.2.0
 *
 * Included libraries:
 *   DataTables 1.10.12, AutoFill 2.1.2, ColReorder 1.3.2, FixedColumns 3.2.2, FixedHeader 3.1.2, KeyTable 2.1.2, Responsive 2.1.0, RowReorder 1.1.2, Scroller 1.4.2, Select 1.2.0
 */
    ...
    (function ($, window, document, undefined) {
        ...
        */
        ...
        DataTable.defaults = {
             ...
             * true, will cause Yajra\Datatables\Datatables; to defer the creation of the table elements for
             ...
             * table has already been initialised, this parameter will cause Yajra\Datatables\Datatables;
             ...
             * enabled) will cause Yajra\Datatables\Datatables; to collapse the table's viewport down when
        ...
        DataTable.ext = _ext = {
             ...
             *  @type string
             */
            build: "bs/dt-1.10.12,af-2.1.2,cr-1.3.2,fc-3.2.2,fh-3.1.2,kt-2.1.2,r-2.1.0,rr-1.1.2,sc-1.4.2,se-1.2.0",
...
(function (factory) {
     ...
     * options to use Yajra\Datatables\Datatables;' child row display to show / hide the information
    ...
    $.extend(Responsive.prototype, {
        ...
        _constructor: function () {
            ...
            // use Yajra\Datatables\Datatables;' throttle function to avoid processor thrashing on
            // resize
         ...
         *
         * We don't use Yajra\Datatables\Datatables;' column visibility controls in order to ensure
