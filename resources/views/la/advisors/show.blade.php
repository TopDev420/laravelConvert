...
<div id="page-content" class="profile2">
	<div class="bg-success clearfix">
		...
		<div class="col-md-1 actions">
			@la_access("Advisors", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/advisors/'.$employee->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Advisors", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.advisors.destroy', $employee->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/advisors') }}" data-toggle="tooltip" data-placement="right" title="Back to Advisors"><i class="fa fa-chevron-left"></i></a></li>
	...
	<div class="tab-content">
		...
		<div role="tabpanel" class="tab-pane fade" id="tab-account-settings">
			<div class="tab-content">
				<form action="{{ url(config('laraadmin.adminRoute') . '/change_passwords/'.$employee->id) }}" id="password-reset-form" class="general-form dashed-row white" method="post" accept-charset="utf-8">
					{{ csrf_field() }}
					<div class="panel">
						<div class="panel-default panel-heading">
