...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $businesscontact->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("BusinessContacts", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/businesscontacts/'.$businesscontact->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("BusinessContacts", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.businesscontacts.destroy', $businesscontact->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/businesscontacts') }}" data-toggle="tooltip" data-placement="right" title="Back to BusinessContacts"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'direct_phone')
						@la_display($module, 'elink')
						@la_display($module, 'clink')
						@la_display($module, 'address1')
						@la_display($module, 'address2')
						@la_display($module, 'county')
						@la_display($module, 'active')
						@la_display($module, 'Business Model')
						...
						@la_display($module, 'company_website')
						@la_display($module, 'phone_number')
						@la_display($module, 'city')
						@la_display($module, 'state')
						@la_display($module, 'zipcode')
						@la_display($module, 'country')
						@la_display($module, 'industries')
						@la_display($module, 'employees')
						@la_display($module, 'revenue')
					</div>
				</div>
			</div>
		</div>
