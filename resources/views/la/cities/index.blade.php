			...
			<div class="modal-body">
				<div class="box-body">
                   <!-- @la_form($module)
					...
					<div class="form-group"><label for="description">Text On List :</label><textarea class="form-control" placeholder="Text On List" cols="30" rows="3" name="list_text"></textarea></div>

					 <div class="form-group">
						<label for="role">Show in list page ? </label>
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/city_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
