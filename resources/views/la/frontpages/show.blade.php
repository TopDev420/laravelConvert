...
<div id="page-content" class="profile2">
 ...
 -->		</div>
		<div class="col-md-1 actions">
			@la_access("Frontpages", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/frontpages/'.$frontpages->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Frontpages", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.frontpages.destroy', $frontpages->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/frontpages') }}" data-toggle="tooltip" data-placement="right" title="Back to Front Pages"><i class="fa fa-chevron-left"></i></a></li>
