...
@section("contentheader_title", "HealthProfessionals")
@section("contentheader_description", "HealthProfessionals listing")
@section("section", "HealthProfessionals")
@section("sub_section", "Listing")
@section("htmlheader_title", "HealthProfessionals Listing")

@section("headerElems")
@la_access("HealthProfessionals", "create")
	
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Health Professional</button>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add HealthProfessionals</h4>
			</div>
			{!! Form::open(['action' => 'LA\HealthProfessionalController@store', 'id' => 'businesscontact-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/healthprofessionals_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
