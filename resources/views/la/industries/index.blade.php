...
@section("contentheader_title", "Industries")
@section("contentheader_description", "Industries listing")
@section("section", "Industries")
@section("sub_section", "Listing")
@section("htmlheader_title", "Industries Listing")

@section("headerElems")
@la_access("Industries", "create")
	
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Industries</button>
...
<div class="box box-success">
	...
	<div class="box-body">
		...
		<tr class="success" role="row">
			...
			<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending" style="width: 125px;">Price</th>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add Industries</h4>
			</div>
			{!! Form::open(['action' => 'LA\IndustryController@store', 'id' => 'businesscontact-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/industries_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
