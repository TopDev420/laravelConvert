...
@section("contentheader_title", "JobLevels")
@section("contentheader_description", "JobLevels listing")
@section("section", "JobLevels")
@section("sub_section", "Listing")
@section("htmlheader_title", "JobLevels Listing")

@section("headerElems")
@la_access("JobLevels", "create")
	
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Job Levels</button>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add Job Levels</h4>
			</div>
			{!! Form::open(['action' => 'LA\JobLevelController@store', 'id' => 'businesscontact-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/joblevels_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
