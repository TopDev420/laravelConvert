	...
	<div class="box box-warning">
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<input class="form-control" placeholder="Enter Image" required="1" name="image" value="0" type="hidden">
				<a class="btn btn-default btn_upload_image" file_type="image" selecter="image">Upload <i class="fa fa-cloud-upload"></i></a>
				<div class="uploaded_image hide"><img src=""><i title="Remove Image" class="fa fa-times"></i>
				</div>
				<div class="uploaded_image hh"><img src="{{$configs->logo}}"><i title="Remove Image" class="fa fa-times"></i></div>
			</div><br>
