...
@section("contentheader_title", "RealEstateAgents")
@section("contentheader_description", "RealEstateAgents listing")
@section("section", "RealEstateAgents")
@section("sub_section", "Listing")
@section("htmlheader_title", "RealEstateAgents Listing")

@section("headerElems")
@la_access("RealEstateAgents", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Real Estate Agent</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add Real Estate Agent</h4>
			</div>
			{!! Form::open(['action' => 'LA\RealEstateAgentController@store', 'id' => 'priceslake-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/realestateagents_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
