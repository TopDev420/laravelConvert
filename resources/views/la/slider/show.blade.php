...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<!-- <div class="col-md-9">
					<h4 class="name">{{ $frontpages->$view_col }}</h4>
					<div class="row stats">
 ...
 -->		</div>
		<div class="col-md-1 actions">
			@la_access("Slider_Images", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/slider_images/'.$frontpages->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Slider_Images", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.slider_images.destroy', $frontpages->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/slider_images') }}" data-toggle="tooltip" data-placement="right" title="Back to Slider Images"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'description_second')
					</div>
				</div>
			</div>
		</div>	
