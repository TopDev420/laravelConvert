			...
			<div class="rr-auth-box">
				<div class="signup-pending">
					...
					<div class="col-xs-12 col-sm-6 oauth-signup">
						<form class="row form-box " action="{{ url('/updatepassword/'.$token) }}" method="post" role="form">
							...
							<div class="form-group">
								...
								<div class="peeky-placeholder-wrapper" is-invalid="false" required="required">
									<label for="new_password" class="peeky-placeholder ">
									<input id="new_password" name="new_password" type="password" ply-unique-email-validator="" placeholder="New Pasword" autocomplete="password" class="form-control" is-invalid="false"  style=""><span>New Password</span></label>
								</div>
							</div>
							@if($errors->has('new_password'))
								<div class="errors">{{ $errors->first('new_password') }}</div>
							@endif
							<div class="form-group">

								<div class="peeky-placeholder-wrapper" is-invalid="false" >
									<label for="confirm_password" class="peeky-placeholder ">
									<input id="confirm_password" name="confirm_password" type="password" ply-unique-email-validator="" placeholder="Confirm Password" autocomplete="password" class="form-control" is-invalid="false"  style=""><span>Confirm Password</span></label>
								</div>
							</div>
							@if($errors->has('confirm_password'))
								<div class="errors">{{ $errors->first('confirm_password') }}</div>
							@endif
							...
							<div>
								<p class="password-reset-description">To reset your password, fill out this form, then go to login.</p>
							</div>
							</fieldset>
						</form>
					</div>
