...
<div class="">
    ...
    <!-- End Side bar -->
    <section class="site-content" style="margin-top:0px!important">
        <main>
                    ...
                    <div class="filter-container contact-filter-container">
                        <div class="filter-parents">
                            ...
                            <div class="dropdown-section " id="jobtitle">
                                <div class="dropdown-box"><i class="fa fa-id-badge" aria-hidden="true"></i> Job Title
                                    <svg width="18" height="18" viewBox="0 0 24 24" class="dropdown-icon plus-icon">
                                        <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
                                    </svg>
                                    <div class="dropdown-icon">
                            ...
                            <div class="dropdown-section" id="industry">
                                <div class="dropdown-box"><i class="fa fa-building-o" aria-hidden="true"></i> Industry
                                    <svg width="18" height="18" viewBox="0 0 24 24" class="dropdown-icon plus-icon">
                                        <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
                                    </svg>
                                    <div class="dropdown-icon">
                            ...
                            <div class="dropdown-section" id="employeecount">
                                <div class="dropdown-box"><i class="fa fa-users" aria-hidden="true"></i> Employee Count
                                    <svg width="18" height="18" viewBox="0 0 24 24" class="dropdown-icon plus-icon" >
                                        <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
                                    </svg>
                                    <div class="dropdown-icon">
                            ...
                            <div class="dropdown-section " id="revenue">
                                <div class="dropdown-box"><i class="fa fa-usd" aria-hidden="true"></i> Revenue
                                    <svg width="18" height="18" viewBox="0 0 24 24" class="dropdown-icon plus-icon">
                                        <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
                                    </svg>
                                    <div class="dropdown-icon">
                            ...
                            <div class="dropdown-section " id="country">
                                <div class="dropdown-box"><i class="fa fa-globe" aria-hidden="true"></i> Country
                                    <svg width="18" height="18" viewBox="0 0 24 24" class="dropdown-icon plus-icon">
                                        <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
                                    </svg>
                                    <div class="dropdown-icon">
                            ...
                            <div class="dropdown-section " id="state">
                                <div class="dropdown-box blocked-wrap"><i class="fa fa-map-o" aria-hidden="true"></i> State
                            ...
                            <div class="dropdown-section " id="city">
                                <div class="dropdown-box blocked-wrap"><i class="fa fa-map-signs" aria-hidden="true"></i> City
                                    <svg width="18" height="18" viewBox="0 0 24 24" class="dropdown-icon plus-icon" style="display : none">
                                        <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
                                    </svg>
                                    <div class="dropdown-icon">
                            ...
                            <div class="dropdown-section" id="businesstype">
                                <div class="dropdown-box"><i class="fa fa-briefcase" aria-hidden="true"></i> Business Type
                                    <svg width="18" height="18" viewBox="0 0 24 24" class="dropdown-icon plus-icon">
                                        <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
                                    </svg>
                                    <div class="dropdown-icon">
                            ...
                            <div class="dropdown-section" id="businessmodel">
                                <div class="dropdown-box"><i class="fa fa-tachometer" aria-hidden="true"></i> Business Model
                                    <svg width="18" height="18" viewBox="0 0 24 24" class="dropdown-icon plus-icon">
                                        <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
                                    </svg>
                                    <div class="dropdown-icon">
                            ...
                            <div class="dropdown-section" id="yearfounded">
                                <div class="dropdown-box"><i class="fa fa-calendar" aria-hidden="true"></i> Business Year Founded
                                    <svg width="18" height="18" viewBox="0 0 24 24" class="dropdown-icon plus-icon">
                                        <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
                                    </svg>
                                    <div class="dropdown-icon">
                    ...
                    <div class="adv-leads-action">
                        <div class="adv-contact-action-btn-wrap">
                            <div class="contact-action-btn selection-wrap">
                                ...
                                <div class="">
                                    <div class="contact-chechk-box-wrap leads-count"  style="display:none; border-radius: 5px;border: 1px solid #bfdeff;background-color: #fff;padding: 0 10px;align-items: center; cursor: pointer;position: relative;">
                                        {{$allcontacts}} Contacts <i class='bx bxs-contact' ></i>
                                    </div>
                                </div>
                                @endif
                            </div>
                        ...
                        <div class="pagination-parent-wrap" style="display:flex;padding: 0px 30px;">
                            <div class="row-range" style="display:flex; padding: 0px 10px;">
                                <lable for="no_of_rows" style="width: max-content;padding: 4px 10px;">Show Rows:</lable>
                            ...
                            <div class="pagination-wrap" style="padding: 0px 10px;">
                            ...
                            <table id="example">
                                <thead>
                                    <tr class="contact-header">
                                        ...
                                        <th><div class="contact-header-item contact-name">Name<div class="sort_carret"><div class="up"><i class='bx bx-caret-up' ></i></div><div class="down"><i class='bx bx-caret-down'></i></div></div></div></th>
                                        <th><div class="contact-header-item contact-title">Title<div class="sort_carret"><div class="up"><i class='bx bx-caret-up' ></i></div><div class="down"><i class='bx bx-caret-down'></i></div></div></div></th>
                                        <th><div class="contact-header-item company-name">Company<div class="sort_carret"><div class="up"><i class='bx bx-caret-up' ></i></div><div class="down"><i class='bx bx-caret-down'></i></div></div></div></th>
                                        <!--<th><div class="contact-header-item email">Contact Info</div></th>-->
                                        <th><div class="contact-header-item email">Email</div></th>
                                        <th><div class="contact-header-item phone-number">Phone Number</div></th>
                                        <th><div class="contact-header-item contact-action">Action</div></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($business_contacts as $row)
                                    <!--<tr>-->
                                        <tr class="contact-item" style="">
                                            <td>
                                                
                                                <div class="contact-check-box-wrap" style="padding: 10%;">
                                                    <div class="common-check-box ">
                                                        <div class="common-check-box-content">
                                                            <div class="empty-check-box"></div>
                                            ...
                                            <td style="padding:2px">
                                                <div class="contact-name" style="padding:2px">
                                                    <div class="id item-id" style="display:none">{{$row->id}}</div>
                                                    <div class="name item-name" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">{{ $row->first_name}} {{ $row->last_name}}</div>
                                                    <!--<div class="title item-title" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">{{$row->job_title}}</div>-->
                                                </div>
                                            </td>
                                             <td >
                                                <div class="contact-name" style="padding: 2px 8px;">
                                                    <div class="id item-id" style="display:none">{{$row->id}}</div>
                                                    <!--<div class="name item-name" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">{{ $row->first_name}} {{ $row->last_name}}</div>-->
                                                    <div class="title item-title" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">{{$row->job_title}}</div>
                                                </div>
                                            ...
                                            <td>
                                                <div class="company-name" style="padding:2px">
                                                    <div class="name item-cname" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis; color:#2080ee">{{ $row->company_name}}</div>
                                                    <div class="company-address-info" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;"><i class="fa fa-map-marker" aria-hidden="true"></i> {{ $row->city}},{{ $row->state}},{{ $row->country}}</div>
                                                </div>
                                                
                                            </td>
                                            <td>
                                                
                                                <div class="email item-email" style="padding:2px"><i class="fa fa-envelope" aria-hidden="true"></i> {{ $row->email_address }}</div>
                                            </td>
                                            <td>
                                                <div class="phone-number" style="padding:2px">
                                                    <div class="name item-dphone"><i class="fa fa-phone" aria-hidden="true"></i> {{ $row->direct_phone}}</div>
                                                    <div class="name item-phone"><i class="fa fa-phone" aria-hidden="true"></i> {{ $row->phone_number}}</div>
                                                </div>
                                                
                                            </td>
                                            <td>
                                                
                                                <div class="contact-action" style="padding:2px">
                                                    <div class="contact-action-btn-wrap">
                                                        @if($userinfo->view_contact == 1)
                                                        <div class="contact-action-btn view-contact viewContactSingleLB"><i class="fa fa-eye" style="color:white" aria-hidden="true"></i> View
                                                            Contact</div>
                                                        @endif
                                                    </div>
                                                </div>
...
<script>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(data.nocredit) {
                    ...
                    $("#realtime_credit").html('Unused Credits ' + data.credit);
                }
            }
        });
    });
    ...
    $("#selectCurrent").click(function(e) {
        ...
        if(count > credit) {
            ...
            $("#realtime_credit").html('Unused Credits ' + (credit- count));
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                for ( i = 0 ;i < result.length ;i++) {
                    if({{$userinfo->view_contact}} == 1) {
                        $(".contact-list-wrap").append('<tr class="contact-item">  <td>  <div class="contact-check-box-wrap">    <div class="common-check-box">    <div class="common-check-box-content">        <div class="empty-check-box"></div><div class="common-check-box-svg-wrap"><svg width="16" height="14" viewBox="0 0 16 14"><path d="M2 8.5L6 12.5L14 1.5"></path></svg>          </div>        </div>        </div>   </div>  </td>  <td padding="2px">  <div class="contact-name">    <div class="id item-id" style="display:none">'+result[i]['id']+'</div>    <div class="name item-name" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">'+result[i]['first_name']+' ' +result[i]['last_name'] + '</div>  </div>  </td>  <td padding="2px 8px">      <div class="contact-name">    <div class="id item-id" style="display:none">'+result[i]['id']+'</div>    <div class="title item-title" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">'+ result[i]['job_title'] + '</div>   </div>  </td>  <td padding="2px">  <div class="company-name"><div class="name item-cname" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">'+ result[i]['company_name']+'</div>    <div class="company-address-info" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;"><i class="fa fa-map-marker" aria-hidden="true"></i> '+result[i]['city']+','+result[i]['state']+','+result[i]['country']+'</div>    </div>   </td>  <td style="padding:2px">   <div class="email item-email"><i class="fa fa-envelope" aria-hidden="true"></i> '+result[i]['email_address']+'</div>  </td>    <td style="padding:2px">    <div class="phone-number"><div class="name item-dphone"><i class="fa fa-phone" aria-hidden="true"></i> '+result[i]['direct_phone']+'</div>    <div class="name item-phone"><i class="fa fa-phone" aria-hidden="true"></i> '+result[i]['phone_number']+'</div> </div>  </td>  <td style="padding:2px"> <div class="contact-action"><div class="contact-action-btn-wrap"><div class="contact-action-btn view-contact viewContactSingleLB">View contact</div></div></div></td></tr>');
                    } else if({{$userinfo->view_contact}} ==0 ) {
                        $(".contact-list-wrap").append('<tr class="contact-item">  <td>    <div class="contact-check-box-wrap">      <div class="common-check-box">        <div class="common-check-box-content">          <div class="empty-check-box"></div>          <div class="common-check-box-svg-wrap"><svg width="16" height="14" viewBox="0 0 16 14">              <path d="M2 8.5L6 12.5L14 1.5"></path>            </svg>          </div>        </div>      </div>    </div>  </td>  <td style="padding:2px">    <div class="contact-name">      <div class="id item-id" style="display:none">'+result[i]['id']+'</div>      <div class="name item-name" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">'+result[i]['first_name']+' ' +result[i]['last_name'] + '</div>    </div>  </td>    <td style="padding:2px 8px">    <div class="contact-name">      <div class="id item-id" style="display:none">'+result[i]['id']+'</div>      <div class="title item-title" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">'+ result[i]['job_title'] + '</div>    </div>  </td>  <td style="padding:2px">    <div class="company-name">      <div class="name item-cname" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis; color:#2080ee">'+ result[i]['company_name']+'</div>      <div class="company-address-info" style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;"><i class="fa fa-map-marker" aria-hidden="true"></i> '+result[i]['city']+','+result[i]['state']+','+result[i]['country']+'</div>    </div>  </td>  <td style="padding:2px">    <div class="email item-email"><i class="fa fa-envelope" aria-hidden="true"></i> '+result[i]['email_address']+'</div>  </td>  <td style="padding:2px">    <div class="phone-number">      <div class="name item-dphone"><i class="fa fa-phone" aria-hidden="true"></i> '+result[i]['direct_phone']+'</div>      <div class="name item-phone"><i class="fa fa-phone" aria-hidden="true"></i> '+result[i]['phone_number']+'</div>    </div>  </td>  <td>    <div class="contact-action">      <div class="contact-action-btn-wrap"></div>    </div>  </td></tr>');    
                    }
                }
