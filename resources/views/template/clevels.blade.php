        ...
        <div class="container jmbtrn-list-detail-container table-layout-fixed">
            ...
            <div class="jmbtrn-list-detail-col-half jmbtrn-list-detail-col-right">
                <div class="breadbrumb">
                    ...
                    <a href="#" class="breadbrumb-item">Ready-Made List by Job Levels</a>
                    <span class="breadbrumb-item">{{ucfirst($functionDetails->slug)}}</span>
                </div>
                <div class="gap-bottom-small">
                    <h1 class="jmbtrn-title">{{ucfirst($functionDetails->slug)}} EMAIL LIST</h1>
                ...
                <div class="gap-bottom-medium hidden-tlnd">
                        ...
                        List</a>
	                     ...
	                     @if(!empty($readymadelistdata['types']))
	                       <input type="hidden" name="type" class="price-filter type" value="{{$readymadelistdata['types']}}">
	                    @endif   
	                     @if(!empty($readymadelistdata['saveid']))
	                       <input type="hidden" name="savesearchid" class="price-filter savesearchid" value="{{$readymadelistdata['saveid']}}">
	                    @endif  
	                     @if(!empty($readymadelistdata['priceencrypt']))
	                       <input type="hidden" name="buyprice" class="price-filter buyprice" value="{{$readymadelistdata['priceencrypt']}}">
	                    @endif  
	                    @if(!empty($readymadelistdata['countencrypt']))
	                       <input type="hidden" name="buycontact" class="price-filter buycontact" value="{{$readymadelistdata['countencrypt']}}">
	                    @endif 
        ...
        <div class="container">
            <div class="row gap-bottom-large">
                ...
                <div class="col-md-6 col-md-offset-1">
                    <h2 class="primary-title h3">{{$functionDetails->slug}} </h2>
                    <p>{{$functionDetails->description}}<br><br>{{$functionDetails->more_desc}}</p>
                </div>
            </div>
