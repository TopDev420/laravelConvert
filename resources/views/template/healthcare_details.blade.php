        ...
        <div class="container jmbtrn-list-detail-container table-layout-fixed">
            ...
            <div class="jmbtrn-list-detail-col-half jmbtrn-list-detail-col-right">
                <div class="breadbrumb">
                    ...
                    <a href="#" class="breadbrumb-item">Ready-Made List by Healthcare Professionals</a>
                    <span class="breadbrumb-item">{{ucfirst($functionDetails->slug)}}</span>


                </div>
                <div class="gap-bottom-small">
                    <h1 class="jmbtrn-title">{{$functionDetails->slug}} EMAIL LIST</h1>
                ...
                <div class="gap-bottom-medium hidden-tlnd">
                    ...
                    <a href="#" class="button button-primary gap-right-plnu full-width-pld gap-bottom-small-pld buylistsingle">Buy
                        Now</a>
                    @endif    
                    <a href="<?Php echo url("/tool/healthcare/{$link}") ?>" class="button button-secondary full-width-pld">Customize This
                        List</a>
