            ...
            <div class="container page-title-container table-layout-fixed">
                ...
                <div class="page-title-col page-title-col-4"><a
                    ...
                    <div class="page-title-col page-title-col-4"><a
                        ...
                        class="checkout-steps-link checkout-steps-link-tool is-active" aria-current="true" href="{{ url('/tool/healthcare') }}"><span

                        class="checkout-steps-link-text">Healthcare Professionals</span></a></div>

                        <div class="page-title-col page-title-col-4"><a

                            class="checkout-steps-link checkout-steps-link-tool" aria-current="false" href="{{ url('/tool/real_estate') }}"><span
                            ...
                            <div>
                                ...
                                <div class="gap-bottom-small">
                                    ...
                                    <div class="c-filter-selectbox has-selected">
                                       ...
                                       <a href="javascript:void(0)" class="over" onclick="toggleVisibility('div_country', 'country');" type="button" data-box="div_country" id="country">  
                    ...
                    <div class="c-filter-selectbox-content c-filter-selectbox-content-fixed-footer">
                        ...
                        <div class="c-filter-search">
                            ...
                            <div class="relative"><span
                                ...
                                class="c-filter-search-input stateSearch" value=""
                                ...
                                <div class="c-filter-search-results">
                                    ...
                                    <div class="c-filter-search-results-inner">
                                        ...
                                        <ul class="c-choice-tree statelist" style="overflow-x:auto;height: 235px;">
...
<div class="c-filter-selectbox-actions u-gap-top-auto">
    ...
    <div class="u-gap-left-auto"><button type="button" data-id="include"
        ...
        aria-hidden="true"></i>Include</button><button data-id="Exclude"
...
<div>
    ...
    <div class="gap-bottom-small " style="display: none;"><input type="text" value="" class="form-control Zip-codes zipcod"
                                ...
                                <div>
                                    ...
                                    <div class="gap-bottom-small">
                                        ...
                                        <div class="c-filter-selectbox">
                                            ...
                                            <a href="javascript:void(0)" class="over" onclick="toggleVisibility('div_job', 'Specialty');" type="button" data-box="div_job" id='Specialty'>

                                                <div class="c-filter-selectbox-trigger" role="button" tabindex="0"><span

                                                    class="c-filter-selectbox-placeholder-text">Specialty<span class="remove-number c-badge c-badge-success u-no-shrink gap-right-small" id="Specialty_number" style="display: none;"></span></span><span
                                                ...
                                                <div class="c-filter-selectbox-container">
                                                    ...
                                                    <div class="u-flex u-flex-extend">
                                                        ...
                                                        <div class="c-filter-selectbox-content c-filter-selectbox-content-fixed-footer">
                                                            ...
                                                            <div>
                                                                ...
                                                                <h5 class="secondary-title clear-gap-top">SELECT FOR SPECIALTIES</h5>

                                                                <p class="font-small">You can select one or more specialty.</p>
                                                            ...
                                                            <div class="c-filter-search">
                                                                ...
                                                                <div class="relative"><span
                                                                    ...
                                                                    class="c-filter-search-input specialtysearch" value=""
                                                                            ...
                                                                            style="flex: 1 1 0%;">
                                                                                ...
                                                                                style="height: 100%;">
                                                                                    ...
                                                                                    style="margin-right: 0px; height: 100%; overflow-y: visible;">
                                                                                            ...
                                                                                            <ul class="c-choice-tree specialtylist" style="overflow-x:auto;height: 235px;">



                                                                                                @if(!empty($filter_healthprofessionals))

                                                                                                @foreach($filter_healthprofessionals as $filter_job)

                                                                                                <li class="c-choice-tree-item">

                                                                                                    <div class="custom-checkbox custom-checkbox-primary c-choice-tree-checkbox">

                                                                                                        <input class="custom-checkbox-inp filter_result specialty-select"  value="{{$filter_job}}" type="checkbox" id="{{$filter_job}}" name="Specialty" data-id="Specialty"><label

                                                                                                        for="{{$filter_job}}"

                                                                                                        class="custom-checkbox-mask"></label>

                                                                                                    </div><label for="{{$filter_job}}" class="c-choice-tree-label">{{$filter_job}}</label>
                                                    ...
                                                    <div class="c-filter-selectbox-content bg-concrete">
                                                        ...
                                                        <div>
                                                            ...
                                                            <h5 class="secondary-title clear-gap-top">SELECTED SPECIALTIES</h5>
                                                            <button type="button" class="modal-close-btn close-btn hide-show-divs"></button>

                                                            <p class="font-small">Specialties that you've chosen.</p>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="c-filter-selected-list-inner">
                                                                ...
                                                                class="c-filter-selected-list-items Specialty">
                                                                                            ...
                                                                                            <p class="Specialty_count c-filter-selected-list-item">There is no Selected item.</p>
...
<div class="gap-bottom-small">
    ...
    <div class="c-filter-selectbox">
       ...
       <a href="javascript:void(0)" class="over" onclick="toggleVisibility('div_company', 'company');" type="button" data-box="div_company" id="company"> <div class="c-filter-selectbox-trigger" role="button" tabindex="0" id='company'><span
            ...
            <div class="row">
                ...
                <div class="col-md-11">
                    ...
                    <div class="tags" style="margin-bottom: 0px;">
                        ...
                        <span class="tag-firsts tag" new-data="United States" data-id="country">Country: United
                        ...
                        <span class="job-level-value-exist">
                            ...
                            <span class="all_selected_value"> 
                                ...
                                <li class="filter-save-data" new-data="{{$searchByJob}}" data-id="Specialty">{{$dataId}} : {{$searchByJob}} <button type="button" class="removefiles fa fa-times "></button></li>
                        ...
                        <span class="tag" new-data="{{$val}}" data-id="country"> {{$p}} : {{$val}} 
                            <button type="button" class="tag-remove removefiles"></button>
...
<script type="text/javascript">
   ...
   var SerachType='businesshealthcare';
...
<script type="text/javascript">
    ...
    $(document).on('click','.removefiles',function(){
        ...
        if(cunrrcategory=='company'){
          $.each(companies,function(index,value){
            if(value== null){
            }else if(value.value==cunrrcategoryvalue && index!=null){
               delete companies[index];
        ...
        $('.all_selected_value_exclude li').each(function(){
            ...
            if(category=='state'){
                ...
                specialtyexclude.push($(this).attr('new-data'));
            }
        });
		if(state!=''){
            data['state'] = state;
        ...
        if(specialtyexclude != ''){
            data['Specialty_exclude']=specialtyexclude;
            check=1;
        }
		...
		Specialty_counts = specialty.length;
		if(Specialty_counts>0){
			$('.Specialty_count').html("There is "+ Specialty_counts +" Selected item"); 
			$('#Specialty_number').html(Specialty_counts);
		}
        if(specialtyexclude.length>0){
            $('.Specialty_count').html("There is "+ specialtyexclude.length +" Selected item"); 
            $('#Specialty_number').html(specialtyexclude.length);
        }
        if(Specialty_counts==0 && specialtyexclude.length==0 && cunrrcategory=='Specialty'){
            removealltypeattr(cunrrcategory);
			$('.Specialty_count').html("There is No Selected item"); 
			$('#Specialty_number').hide(); 
		}
        ...
        if(countries_length == 0 && cunrrcategory=='country'){
             removealltypeattr(cunrrcategory);
            //$('.company_count').html("There is No Selected item"); 
            $('#remove-country').hide();
            $('#remove-country').html(''); 
        }else{
            $('#remove-country').html(countries_length); 
        }
		if(check==1){
    		...
    		$('div.remove-all div.tags span.tag').remove();
    		$('.remove-spans').hide();
    		$('.table').hide();
    		...
    		$('#rundiv-app').show();
    		$('#rundiv-app').html('<div class="shadow-primary section-flex section-flex-tool-no-result"> <div class="full-width section-flex-container"><div class="section-flex-inner"><div class="row"> <div class="col-sm-8 col-sm-offset-2"><div><h3 class="primary-title clear-gap-top gap-bottom-small">Welcome to Bookyourdata</h3><p class="gap-bottom-medium">Run an example search for <strong>United States</strong></p> </div><button type="button" class="button button-primary include-run-box">Run an Example Search</button></div></div> </div> </div></div>');
        ...
        $(document).on('click','.save_my_list',function(){
            ...
            $.ajax({
                ...
                data: {
                    ...
                    'userid': userid, 'listname': listname, 'listamnt': listamnt, 'totlcontact': totlcontact, 'result': result, 'industry': industries, 'company': company, 'state': state, 'city': city,'zipcode':zipcode,'Specialty':specialty,'Jobfunctions':job_funtion,'ranfgeofstyle':rangeofstyle,'country':countries,'range_of_contact':$( "input.form-control-adjust" ).val(),
...
<script type="text/javascript">
$(document).on('click','.specialty-select',function(){
    var  spc_data=$(this).val();
    var dataidnot=null;
    var dataoflocal = localStorage.getItem('checkedkey');     
    $(document).find('input[name=Specialty]').each(function(){ 
...
<script src="{{ asset('new-assets/js/health.js') }}"></script>
