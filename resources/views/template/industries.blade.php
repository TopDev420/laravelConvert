            ...
            <div class="jmbtrn-inner">
                <div class="row">
                    <div class="col-md-6 gap-bottom-tld">
                        <h1 class="jmbtrn-title">Email Lists By <br /> INDUSTRIES</h1>
                        <div class="breadbrumb">
                            <a href="/" class="breadbrumb-item">Home</a>
                            <span class="breadbrumb-item">Ready-Made List by INDUSTRIES</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <p>Connect with the right people with our industry-specific, pre-built contact lists. Buy a mailing list by industry that’s verified and accurate, and market to businesses in relevant industries, such as hospitality, construction, marketing, or any of the industries listed below. When you buy email lists by industry, you’ll get premium, targeted sales leads!</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="main-content pad-bottom-medium">
        <div class="container regular-page-content regular-page-content-pull-top">
            ...
            <div class="premade-lists gap-bottom-small">
                ...
                <a href="<?Php echo url("/email-list-industries/{$levels->slug}") ?>" class="premade-lists-item">
