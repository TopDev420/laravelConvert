            ...
            <div class="jmbtrn-inner">
                <div class="row">
                    <div class="col-md-6 gap-bottom-tld">
                        <h1 class="jmbtrn-title">Email Lists By Job<br /> FUNCTIONS</h1>
                        <div class="breadbrumb">
                            <a href="/" class="breadbrumb-item">Home</a>
                            <span class="breadbrumb-item">Ready-Made List by Job Function</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <p>Network with people in departments that are most relevant to your product or service, whether that be HR, management, or any of the departments listed below. Market to those in related offices of multiple companies with our verified, accurate lists.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="main-content pad-bottom-medium">
        <div class="container regular-page-content regular-page-content-pull-top">
            ...
            <div class="premade-lists gap-bottom-small">
                ...
                <a href="<?Php echo url("/email-list-functions/{$levels->slug}") ?>" class="premade-lists-item">
