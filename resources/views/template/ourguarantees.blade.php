   ...
   <div class="jmbtrn jmbtrn-regular jmbtrn-regular-bg">
        <div class="container jmbtrn-container">
            <div class="jmbtrn-inner">
                <h1 class="jmbtrn-title">Our Guarantees</h1>
                <div class="breadbrumb">
                    <a href="/" class="breadbrumb-item">Home</a>
                    <span class="breadbrumb-item">Our Guarantees</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 text-center-tpd">
                    <span>
                        <img src="{{ asset('new-assets/images/new/aim.png')}}" alt="">
                    </span>
                    <h3 class="primary-title">95% DELIVERABILITY GUARANTEE</h3>
                    <p>All of our email lists come with a 95% deliverability guarantee.* Why not 100%? The reason for
                        this is
                        ...
                        100% deliverability in this industry. Our aim is to provide you the most up-to-date data. Right
                        now,
                ...
                <div class="col-md-4 pad-top-small-tld text-center-tpd">
                    <span>
                        <img src="{{ asset('new-assets/images/new/left-right-round.png')}}" alt="">
                    </span>
                    ...
                    <p>We know it is bad when a customer thinks the service they received wasn’t worthy of its price.
                        To prevent such situations, we promise a 95% deliverability rate with our data. If a customer
                        runs
                        across an deliverability level lower than 95%, simply send us the report showing the hard-bounce
                        rate of the email list purchased and we will provide free data credits until our 95%
                        deliverability
                ...
                <div class="col-md-4 pad-top-small-tld text-center-tpd">
                    <span>
                        <img src="{{ asset('new-assets/images/new/smile.png')}}" alt="">
                    </span>
                ...
                <div class="col-md-12">
                    <p style="font-size: 13px;">* : We suppose that you will use our data records within next 15 days
                        after you purchase.
                        Poor sender reputation, mail server misconfiguration / unavailability possibilities are
                        disregarded here.</p>
                </div>
            </div>
        </div>
