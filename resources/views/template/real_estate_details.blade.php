            ...
            <div class="jmbtrn-list-detail-col-half jmbtrn-list-detail-col-right">
                ...
                <div class="gap-bottom-medium hidden-tlnd">
                    <!-- @if(!empty($readymadelistdata))
                        @if(@readymadelistdata['total']>0)<button type="submit" class="button button-primary gap-right-plnu full-width-pld gap-bottom-small-pld buylistsingle">Buy Now</button>@endif
                    @endif -->
                    @if($functionDetails->price>0)
                        ...
                        @endif
                    <a href="<?Php echo url("/tool/real_estate/{$link}") ?>" class="button button-secondary full-width-pld">Customize This
                        List</a>
        ...
        <div class="container">
            <div class="row gap-bottom-large">
                ...
                <div class="col-md-6 col-md-offset-1">
                    ...
                    <p>{{$functionDetails->more_desc}}<br></p>
                </div>
            </div>
