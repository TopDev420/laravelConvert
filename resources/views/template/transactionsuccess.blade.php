...
<body>
    ...
    <polyline class="tick path" style="fill:none;stroke:#fff;stroke-width:3;stroke-linejoin:round;stroke-miterlimit:10;" points="
        11.6,20 15.9,24.2 26.4,13.8 "/>
			...
			<?php if($type == 'upgrade') { ?>
            <div class="text">
            <p>Your transaction successful. <br>Here are your details<br>Credit Award: {{$get_credits}}<br>
                Current Credits: {{$current_credits}}<br>
            </p>
                </div>
            <?php } else if($type == 'downgrade') {?>
			<div class="text">
				<p>You have successfully downgraded plan </p>
			</div>
			<?php }?>
			<p class="regards">Regards, Datasyder</p>
			
            <a href="/tool/advanced-search"><input type="button" value="OK" class="to-search-page"></a>
        </div>
